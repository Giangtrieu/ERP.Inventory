...
namespace ERP.Inventory.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260605015006_AddSoftDeleteFieldsToItemInstance")]
    partial class AddSoftDeleteFieldsToItemInstance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.BorrowDocumentLog", b =>
                {
                    ...
                    b.HasIndex("BorrowDocumentId", "Action", "LifecycleBatchId");
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.CurrentItemLocation", b =>
                {
                    ...
                    b.HasIndex("WarehouseId", "BinLocationId");

                    b.HasIndex("WarehouseId", "UpdatedLocationAt");
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.InventoryTransaction", b =>
                {
                    ...
                    b.HasIndex("DocumentType", "DocumentId", "TransactionType", "LifecycleBatchId");
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.ItemInstance", b =>
                {
                    ...
                    b.Property<int?>("DeleteSourceDocumentId")
                        .HasColumnType("int");

                    b.Property<string>("DeleteSourceDocumentType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("DeletedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("DeletedByUserCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RestoredByUserCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.ItemMovementHistory", b =>
                {
                    ...
                    b.HasIndex("DocumentType", "DocumentId", "ActionType", "LifecycleBatchId");
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.QuantityInventoryDocument", b =>
                {
                    ...
                    b.Property<string>("OperatorUserCode")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.QuantityStockLocationBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WarehouseId", "BinLocationId", "ItemId", "Status")
                        .IsUnique();

                    b.ToTable("QuantityStockLocationBalances");
                });
            ...
            modelBuilder.Entity("ERP.Inventory.Domain.Entities.RepairDocumentLog", b =>
                {
                    ...
                    b.HasIndex("RepairDocumentId", "Action", "LifecycleBatchId");
