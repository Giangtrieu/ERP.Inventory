...

{
...

    {
        ...
        ["SystemError.BusinessDependencyMessage"] = "Không thể thực hiện do dữ liệu đang được phiếu khác tham chiếu. Mã lỗi: {0}. Vui lòng xóa hoặc rebuild phiếu phụ thuộc trước.",
        ["SystemError.DeadlockMessage"] = "Dữ liệu đang được xử lý bởi thao tác khác. Mã lỗi: {0}. Vui lòng thử lại sau.",
        ["SystemError.UnauthorizedMessage"] = "Phiên đăng nhập đã hết hạn hoặc chưa đăng nhập. Mã lỗi: {0}. Vui lòng đăng nhập lại.",
        ["SystemError.ForbiddenMessage"] = "Bạn không có quyền thực hiện chức năng này. Mã lỗi: {0}.",
        ["SystemError.NotFoundMessage"] = "Không tìm thấy dữ liệu yêu cầu. Mã lỗi: {0}.",
        ["SystemError.DbUpdateMessage"] = "Có lỗi dữ liệu hệ thống. Mã lỗi: {0}. Vui lòng liên hệ TE/IT.",
        ["error-generic"] = "Đã xảy ra lỗi không mong muốn. Vui lòng thử lại.",
        ["error-timeout"] = "Hệ thống xử lý quá lâu. Vui lòng thử lại.",
        ["error-deadlock"] = "Hệ thống đang bận, vui lòng thử lại.",
        ["error-validation"] = "Dữ liệu không hợp lệ.",
        ["error-business-dependency"] = "Không thể thay đổi chứng từ này vì đã tồn tại giao dịch liên quan.",
        ["inbound-document-not-found"] = "Không tìm thấy phiếu nhập kho.",
        ["move-document-not-found"] = "Không tìm thấy phiếu chuyển kho.",
        ["adjustment-document-not-found"] = "Không tìm thấy phiếu điều chỉnh kho.",
        ["borrow-lend-document-not-found"] = "Không tìm thấy phiếu mượn hàng.",
        ["borrow-return-document-not-found"] = "Không tìm thấy phiếu trả hàng.",
        ["inventory-check-document-not-found"] = "Không tìm thấy phiếu kiểm kê.",
        ["inventory-check-delete-first"] = "Vui lòng xóa phiếu kiểm kê liên quan trước.",
        ["cannot-delete-inbound-inventory-check-exists"] = "Không thể xóa phiếu nhập kho vì đã tồn tại phiếu kiểm kê liên quan.",
        ["cannot-edit-inbound-inventory-check-exists"] = "Không thể sửa phiếu nhập kho vì đã tồn tại phiếu kiểm kê liên quan.",
        ["cannot-delete-move-later-document-exists"] = "Không thể xóa phiếu chuyển kho vì đã tồn tại giao dịch phát sinh sau.",
        ["cannot-delete-adjustment-later-document-exists"] = "Không thể xóa phiếu điều chỉnh vì đã tồn tại giao dịch phát sinh sau.",
        ["cannot-delete-borrow-later-document-exists"] = "Không thể xóa phiếu mượn vì đã tồn tại giao dịch phát sinh sau.",
        ["cannot-delete-inventory-check-surplus-used"] = "Không thể xóa phiếu kiểm kê vì mặt hàng dư đã được sử dụng trong giao dịch phát sinh sau.",
        ["cannot-delete-inventory-check-surplus-source-unverified"] = "Không thể xóa phiếu kiểm kê vì không xác minh được mặt hàng dư do chính phiếu này tạo.",
        ["quantity-must-be-greater-than-zero"] = "Số lượng phải lớn hơn 0.",
        ["item-is-required"] = "Vui lòng chọn mặt hàng.",
        ["warehouse-is-required"] = "Vui lòng chọn kho.",
        ["bin-location-is-required"] = "Vui lòng chọn vị trí kho.",
        ["unsupported-document-type"] = "Loại chứng từ không được hỗ trợ.",
        ["pdf-inbound-title"] = "PHIẾU NHẬP KHO",
        ["pdf-move-title"] = "PHIẾU CHUYỂN KHO",
        ["pdf-adjustment-title"] = "PHIẾU ĐIỀU CHỈNH KHO",
        ["pdf-borrow-lend-title"] = "PHIẾU MƯỢN HÀNG",
        ["pdf-borrow-return-title"] = "PHIẾU TRẢ HÀNG",
        ["pdf-inventory-check-title"] = "PHIẾU KIỂM KÊ",
        ["pdf-quantity-title"] = "PHIẾU TỒN SỐ LƯỢNG",
        ["Sign and full name"] = "Ký, ghi rõ họ tên",
        ["Purpose"] = "Mục đích",
        ["Phone"] = "SĐT",
        ["Department Owner"] = "Chủ quản bộ phận",
        ["Inbound Date"] = "Ngày nhập",
        ["Move No"] = "Số phiếu chuyển",
        ["Move Date"] = "Ngày chuyển",
        ["Adjustment No"] = "Số phiếu điều chỉnh",
        ["Adjustment Date"] = "Ngày điều chỉnh",
        ["Borrow No"] = "Số phiếu mượn",
        ["Borrow Date"] = "Ngày mượn",
        ["Return No"] = "Số phiếu trả",
        ["Return Date"] = "Ngày trả",
        ["Check No"] = "Số phiếu kiểm kê",
        ["Check Date"] = "Ngày kiểm kê",
        ["Supplier / Source Party"] = "Nhà cung cấp / nguồn",
        ["From Warehouse"] = "Kho đi",
        ["To Warehouse"] = "Kho đến",
        ["Borrow Department"] = "Bộ phận mượn",
        ["Borrower"] = "Người mượn",
        ["Expected Return Date"] = "Ngày dự kiến trả",
        ["Original Borrow No"] = "Phiếu mượn gốc",
        ["PIC"] = "Người phụ trách",
        ["Reason"] = "Lý do",
        ...
        ["To Bin"] = "Bin đến",
        ["Before Qty"] = "SL trước",
        ["Adjust Qty"] = "SL điều chỉnh",
        ["After Qty"] = "SL sau",
        ["Return Status"] = "Trạng thái trả",
        ["Borrowed Qty"] = "SL đã mượn",
        ["Returned Qty"] = "SL đã trả",
        ["Remaining Qty"] = "SL còn lại",
        ["System Qty"] = "SL hệ thống",
        ["Actual Qty"] = "SL thực tế",
        ["Variance"] = "Chênh lệch",
        ["Variance Type"] = "Loại chênh lệch",
        ["Prepared By"] = "Người lập",
        ["Checked By"] = "Người kiểm tra",
        ["Approved By"] = "Người duyệt",
        ["Transferred By"] = "Người chuyển",
        ["Received By"] = "Người nhận",
        ["Warehouse Keeper"] = "Thủ kho",
        ["Returned By"] = "Người trả",
        ["BusinessValidation"] = "Lỗi kiểm tra nghiệp vụ",
        ["BusinessDependency"] = "Phụ thuộc nghiệp vụ",
        ["Timeout"] = "Quá thời gian",
        ["Deadlock"] = "Deadlock dữ liệu",
        ["Unauthorized"] = "Chưa đăng nhập",
        ["Forbidden"] = "Không có quyền",
        ["NotFound"] = "Không tìm thấy",
        ["DbUpdateException"] = "Lỗi cập nhật DB",
        ["UnhandledException"] = "Lỗi hệ thống",
        ...
        ["Duration (ms)"] = "Thời gian (ms)",
        ["Technical message"] = "Thông báo kỹ thuật",
        ["Exception type"] = "Loại exception",
        ["SQL error number"] = "Mã lỗi SQL",
        ["Delete all"] = "Xóa tất cả",
        ["Delete all system errors?"] = "Xóa tất cả lỗi hệ thống?",
        ["Delete this system error?"] = "Xóa lỗi hệ thống này?",
        ["Deleted"] = "Đã xóa",
        ["Original file"] = "File gốc",
        ["Preview file"] = "File preview",
        ["Validation errors file"] = "File lỗi validation",
        ["Result file"] = "File kết quả",
        ["Pdf.BorrowLend.Body"] = "Vào ngày <strong>{date}</strong>, tôi tên là <strong>{party}</strong>, mã thẻ <strong>{partyCode}</strong> bộ phận <strong>{department}</strong>, do <strong>{purpose}</strong> cần mượn bản {itemCategoryCode}. Dự định đến <strong>{dueDate}</strong> sẽ mang trả lại, nay viết đơn mượn hàng này để làm chứng, khi mang trả thu lại giấy này.",
        ["Pdf.BorrowReturn.Body"] = "Vào ngày <strong>{date}</strong>, tôi tên là <strong>{party}</strong>, đã mượn hàng theo phiếu <strong>{documentNo}</strong>, nay trả lại các mặt hàng dưới đây về kho.",
        ["Module"] = "Phân hệ",
        ...
        ["Example list code"] = "VD: REF-WH01-2026",
        ["ItemCode / Serial..."] = "Mã hàng / Serial...",
        ["Example bin search"] = "VD: 007, PN001, SN001",
        ["Bin Type"] = "Loại vị trí",
        ["All bin types"] = "Tất cả loại vị trí",
        ["Location tracked bins"] = "Vị trí hàng theo dõi",
        ["Quantity bins"] = "Vị trí hàng số lượng lớn",
        ["LocationTracked"] = "Hàng theo dõi vị trí",
        ...
        ["LOCATION TRACKED BIN LIST"] = "DANH SÁCH BIN THEO HÀNG VỊ TRÍ",
        ["QUANTITY BIN LIST"] = "DANH SÁCH BIN THEO HÀNG SỐ LƯỢNG",
        ["Location tracked occupied bins"] = "Bin hàng vị trí đã sử dụng",
        ["Location tracked empty bins"] = "Bin hàng vị trí còn trống",
        ["Quantity occupied bins"] = "Bin hàng số lượng đã sử dụng",
        ["Quantity empty bins"] = "Bin hàng số lượng còn trống",
        ["Location tracked bins"] = "Bin hàng vị trí",
        ["Quantity bins"] = "Bin hàng số lượng",
        ["Used"] = "Đã sử dụng",
        ["occupied bins"] = "bin đã sử dụng",
        ["Total bins"] = "Tổng số bin",
        ["Occupied bins"] = "Bin đã sử dụng",
...

    {
        ...
        ["SystemError.BusinessDependencyMessage"] = "The operation is blocked because related documents reference this data. Error code: {0}. Delete or rebuild dependent documents first.",
        ["SystemError.DeadlockMessage"] = "The data is being processed by another operation. Error code: {0}. Please try again.",
        ["SystemError.UnauthorizedMessage"] = "Your session has expired or authentication is required. Error code: {0}. Please sign in again.",
        ["SystemError.ForbiddenMessage"] = "You do not have permission to perform this action. Error code: {0}.",
        ["SystemError.NotFoundMessage"] = "The requested data was not found. Error code: {0}.",
        ["SystemError.DbUpdateMessage"] = "A system data error occurred. Error code: {0}. Please contact TE/IT.",
        ["error-generic"] = "An unexpected error occurred. Please try again.",
        ["error-timeout"] = "Request timeout. Please try again.",
        ["error-deadlock"] = "Database is busy. Please retry.",
        ["error-validation"] = "Validation failed.",
        ["error-business-dependency"] = "This document cannot be changed because related transactions already exist.",
        ["inbound-document-not-found"] = "Inbound document not found.",
        ["move-document-not-found"] = "Move document not found.",
        ["adjustment-document-not-found"] = "Adjustment document not found.",
        ["borrow-lend-document-not-found"] = "Borrow document not found.",
        ["borrow-return-document-not-found"] = "Borrow return document not found.",
        ["inventory-check-document-not-found"] = "Inventory check document not found.",
        ["inventory-check-delete-first"] = "Please delete the related inventory check document first.",
        ["cannot-delete-inbound-inventory-check-exists"] = "Cannot delete inbound document because a related inventory check document exists.",
        ["cannot-edit-inbound-inventory-check-exists"] = "Cannot edit inbound document because a related inventory check document exists.",
        ["cannot-delete-move-later-document-exists"] = "Cannot delete move document because later related transactions exist.",
        ["cannot-delete-adjustment-later-document-exists"] = "Cannot delete adjustment document because later related transactions exist.",
        ["cannot-delete-borrow-later-document-exists"] = "Cannot delete borrow document because later related transactions exist.",
        ["cannot-delete-inventory-check-surplus-used"] = "Cannot delete inventory check document because surplus items have been used by later transactions.",
        ["cannot-delete-inventory-check-surplus-source-unverified"] = "Cannot delete inventory check document because a surplus item cannot be verified as created by this inventory check.",
        ...
        ["bin-location-is-required"] = "Bin location is required.",
        ["unsupported-document-type"] = "Unsupported document type.",
        ["pdf-inbound-title"] = "WAREHOUSE INBOUND DOCUMENT",
        ["pdf-move-title"] = "WAREHOUSE TRANSFER DOCUMENT",
        ["pdf-adjustment-title"] = "INVENTORY ADJUSTMENT DOCUMENT",
        ["pdf-borrow-lend-title"] = "BORROW DOCUMENT",
        ["pdf-borrow-return-title"] = "BORROW RETURN DOCUMENT",
        ["pdf-inventory-check-title"] = "INVENTORY CHECK DOCUMENT",
        ["pdf-quantity-title"] = "QUANTITY INVENTORY DOCUMENT",
        ["Sign and full name"] = "Sign and full name",
        ["Purpose"] = "Purpose",
        ["Phone"] = "Phone",
        ["Department Owner"] = "Department Owner",
        ...
        ["Forbidden"] = "Forbidden",
        ["NotFound"] = "Not found",
        ["DbUpdateException"] = "DB update error",
        ["UnhandledException"] = "System error",
        ...
        ["Technical message"] = "Technical message",
        ["Exception type"] = "Exception type",
        ["SQL error number"] = "SQL error number",
        ["Delete all"] = "Delete all",
        ["Delete all system errors?"] = "Delete all system errors?",
        ["Delete this system error?"] = "Delete this system error?",
        ["Deleted"] = "Deleted",
        ["Original file"] = "Original file",
        ["Preview file"] = "Preview file",
        ["Validation errors file"] = "Validation errors file",
        ["Result file"] = "Result file",
        ["Pdf.BorrowLend.Body"] = "On <strong>{date}</strong>, I, <strong>{party}</strong>, badge <strong>{partyCode}</strong>, department <strong>{department}</strong>, need to borrow {itemCategoryCode} for <strong>{purpose}</strong>. I plan to return it by <strong>{dueDate}</strong> and write this borrowing form as proof.",
        ["Pdf.BorrowReturn.Body"] = "On <strong>{date}</strong>, I, <strong>{party}</strong>, return the borrowed items under document <strong>{documentNo}</strong> to the warehouse.",
        ["Module"] = "Module",
        ...
        ["Example list code"] = "Example: REF-WH01-2026",
        ["ItemCode / Serial..."] = "ItemCode / Serial...",
        ["Example bin search"] = "Example: 007, PN001, SN001",
        ["Bin Type"] = "Bin Type",
        ["All bin types"] = "All bin types",
        ["Location tracked bins"] = "Location tracked bins",
        ["Quantity bins"] = "Quantity bins",
...

    {
        ...
        ["SystemError.BusinessDependencyMessage"] = "相关单据正在引用此数据，无法执行该操作。错误代码：{0}。请先删除或重建依赖单据。",
        ["SystemError.DeadlockMessage"] = "数据正在被其他操作处理。错误代码：{0}。请稍后重试。",
        ["SystemError.UnauthorizedMessage"] = "登录会话已过期或需要登录。错误代码：{0}。请重新登录。",
        ["SystemError.ForbiddenMessage"] = "您没有权限执行此功能。错误代码：{0}。",
        ["SystemError.NotFoundMessage"] = "未找到请求的数据。错误代码：{0}。",
        ["SystemError.DbUpdateMessage"] = "系统数据发生错误。错误代码：{0}。请联系 TE/IT。",
        ["error-generic"] = "发生意外错误，请重试。",
        ["error-timeout"] = "请求超时，请重试。",
        ["error-deadlock"] = "数据库繁忙，请重试。",
        ["error-validation"] = "数据验证失败。",
        ["error-business-dependency"] = "由于已存在相关交易，无法更改此单据。",
        ["inbound-document-not-found"] = "未找到入库单。",
        ["move-document-not-found"] = "未找到移库单。",
        ["adjustment-document-not-found"] = "未找到库存调整单。",
        ["borrow-lend-document-not-found"] = "未找到借用单。",
        ["borrow-return-document-not-found"] = "未找到归还单。",
        ["inventory-check-document-not-found"] = "未找到盘点单。",
        ["inventory-check-delete-first"] = "请先删除相关盘点单。",
        ["cannot-delete-inbound-inventory-check-exists"] = "无法删除入库单，因为存在相关盘点单。",
        ["cannot-edit-inbound-inventory-check-exists"] = "无法修改入库单，因为存在相关盘点单。",
        ["cannot-delete-move-later-document-exists"] = "无法删除移库单，因为存在后续相关交易。",
        ["cannot-delete-adjustment-later-document-exists"] = "无法删除调整单，因为存在后续相关交易。",
        ["cannot-delete-borrow-later-document-exists"] = "无法删除借用单，因为存在后续相关交易。",
        ["cannot-delete-inventory-check-surplus-used"] = "无法删除盘点单，因为盘盈物料已被后续交易使用。",
        ["cannot-delete-inventory-check-surplus-source-unverified"] = "无法删除盘点单，因为无法确认盘盈物料由此盘点单创建。",
        ["quantity-must-be-greater-than-zero"] = "数量必须大于0。",
        ["item-is-required"] = "请选择物料。",
        ["warehouse-is-required"] = "请选择仓库。",
        ["bin-location-is-required"] = "请选择库位。",
        ["unsupported-document-type"] = "不支持的单据类型。",
        ["pdf-inbound-title"] = "入库单",
        ["pdf-move-title"] = "移库单",
        ["pdf-adjustment-title"] = "库存调整单",
        ["pdf-borrow-lend-title"] = "借用单",
        ["pdf-borrow-return-title"] = "归还单",
        ["pdf-inventory-check-title"] = "盘点单",
        ["pdf-quantity-title"] = "数量库存单",
        ["Sign and full name"] = "签名并填写姓名",
        ["Purpose"] = "用途",
        ["Phone"] = "电话",
        ["Department Owner"] = "部门主管",
        ["BusinessValidation"] = "业务校验",
        ["BusinessDependency"] = "业务依赖",
        ["Timeout"] = "超时",
        ["Deadlock"] = "数据死锁",
        ["Unauthorized"] = "未登录",
        ["Forbidden"] = "无权限",
        ["NotFound"] = "未找到",
        ["DbUpdateException"] = "数据库更新错误",
        ["UnhandledException"] = "系统错误",
        ...
        ["HTTP Status"] = "HTTP 状态",
        ["Duration (ms)"] = "耗时（毫秒）",
        ["Technical message"] = "技术消息",
        ["Exception type"] = "异常类型",
        ["SQL error number"] = "SQL 错误号",
        ["Delete all"] = "全部删除",
        ["Delete all system errors?"] = "删除所有系统错误？",
        ["Delete this system error?"] = "删除此系统错误？",
        ["Deleted"] = "已删除",
        ["Original file"] = "原始文件",
        ["Preview file"] = "预览文件",
        ["Validation errors file"] = "校验错误文件",
        ["Result file"] = "结果文件",
        ["Pdf.BorrowLend.Body"] = "于 <strong>{date}</strong>，本人 <strong>{party}</strong>，工号 <strong>{partyCode}</strong>，部门 <strong>{department}</strong>，因 <strong>{purpose}</strong> 需要借用 {itemCategoryCode}。预计于 <strong>{dueDate}</strong> 归还，特填写此借货单作为证明，归还时收回此单。",
        ["Pdf.BorrowReturn.Body"] = "于 <strong>{date}</strong>，本人 <strong>{party}</strong> 根据借用单 <strong>{documentNo}</strong> 归还以下借用物品入库，特此证明。",
        ["Module"] = "模块",
        ["Request Path"] = "请求路径",
        ["HTTP Method"] = "HTTP 方法",
        ["Error message"] = "错误消息",
        ...
        ["Example list code"] = "示例：REF-WH01-2026",
        ["ItemCode / Serial..."] = "物料编码 / 序列号...",
        ["Example bin search"] = "示例：007、PN001、SN001",
        ["Bin Type"] = "库位类型",
        ["All bin types"] = "全部库位类型",
        ["Location tracked bins"] = "按位置跟踪库位",
        ["Quantity bins"] = "数量库位",
        ["LocationTracked"] = "按位置跟踪",
        ["Quantity"] = "数量",
        ...
        ["LOCATION TRACKED BIN LIST"] = "位置追踪 BIN 列表",
        ["QUANTITY BIN LIST"] = "数量 BIN 列表",
        ["Location tracked occupied bins"] = "位置追踪 bin 已使用",
        ["Location tracked empty bins"] = "位置追踪 bin 空闲",
        ["Quantity occupied bins"] = "数量 bin 已使用",
        ["Quantity empty bins"] = "数量 bin 空闲",
        ["Quantity Inventory"] = "数量库存",
        ["Location tracked bins"] = "位置追踪 bin",
        ["Quantity bins"] = "数量 bin",
        ["Used"] = "已使用",
        ["occupied bins"] = "已使用 bin",
        ["Total bins"] = "Bin 总数",
        ["Occupied bins"] = "已使用 bin",
        ["Empty bins"] = "空闲 bin",
...

    {
        ...
        ["Deleted inventory check document. Removed {0} surplus item instance(s) created by this inventory check."] = "Đã xóa phiếu kiểm kê. Đã xóa {0} mã vật tư dư được tạo bởi phiếu kiểm kê này.",
        ["Item instance {0}/{1} is referenced by inventory check document {2}. Delete or rebuild the inventory check document first."] = "Mã vật tư {0}/{1} đang được tham chiếu bởi phiếu kiểm kê {2}. Vui lòng xóa hoặc tạo lại phiếu kiểm kê trước.",
        ["Item {0}/{1} is referenced by inventory check document {2}. Delete or rebuild the inventory check document first."] = "Mã vật tư {0}/{1} đang được tham chiếu bởi phiếu kiểm kê {2}. Vui lòng xóa hoặc tạo lại phiếu kiểm kê trước.",
        ["Delete or rebuild the inventory check document first."] = "Vui lòng xóa hoặc tạo lại phiếu kiểm kê trước.",
        ["Delete borrow return/lend lines before removing the inbound item."] = "Vui lòng xóa các dòng mượn/trả liên quan trước khi xóa vật tư nhập kho.",
        ["Delete repair send/receive lines before removing the inbound item."] = "Vui lòng xóa các dòng gửi sửa/nhận sửa liên quan trước khi xóa vật tư nhập kho.",
        ["Delete move lines before removing the inbound item."] = "Vui lòng xóa các dòng điều chuyển liên quan trước khi xóa vật tư nhập kho.",
        ["Delete adjustment lines before removing the inbound item."] = "Vui lòng xóa các dòng điều chỉnh liên quan trước khi xóa vật tư nhập kho.",
    };
...

    {
        ...
        ["Deleted inventory check document. Removed {0} surplus item instance(s) created by this inventory check."] = "已删除盘点单。据此盘点单创建的 {0} 个盘盈物料实例已被删除。",
        ["Item instance {0}/{1} is referenced by inventory check document {2}. Delete or rebuild the inventory check document first."] = "物料实例 {0/{1} 正被盘点单 {2} 引用。请先删除或重建该盘点单。",
        ["Item {0}/{1} is referenced by inventory check document {2}. Delete or rebuild the inventory check document first."] = "物料实例 {0}/{1} 正被盘点单 {2} 引用。请先删除或重建该盘点单。",
        ["Delete or rebuild the inventory check document first."] = "请先删除或重建盘点单。",
        ["Delete borrow return/lend lines before removing the inbound item."] = "删除入库物料前，请先删除相关借出/归还明细行。",
        ["Delete repair send/receive lines before removing the inbound item."] = "删除入库物料前，请先删除相关送修/收修明细行。",
        ["Delete move lines before removing the inbound item."] = "删除入库物料前，请先删除相关调拨明细行。",
        ["Delete adjustment lines before removing the inbound item."] = "删除入库物料前，请先删除相关调整明细行。",
    };
